...
public class RoomsAdapter extends RecyclerView.Adapter<RoomsAdapter.RoomViewHolder> {
    ...
    public void onBindViewHolder(RoomViewHolder holder, int position) {
        ...
        if (!deleteMode) {
            if (room.getIsOn() && room.getIsReachable()) {
            ...
            if (roomsToDelete.contains(room)){
                holder.background.startAnimation(AnimationUtils.loadAnimation(RoomsActivity.mainContext, R.anim.shake));
        ...
        public void onClick(View v) {
            ...
            if (!deleteMode) {
                if (selectedRoom.getIsReachable()) {
                    ...
                    hueController.toggleRoomOn(selectedRoom.getGroup(), !isOn);
