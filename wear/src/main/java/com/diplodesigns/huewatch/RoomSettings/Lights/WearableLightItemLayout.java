 ...
 */
public class WearableLightItemLayout extends LinearLayout
    ...
    public WearableLightItemLayout(Context context) {
        this(context, null);
    }

    public WearableLightItemLayout(Context context, AttributeSet attrs) {
